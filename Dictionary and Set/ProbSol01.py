...
words = {"Kamra":"Room","Kambal":"Blanket","Fonn":"Phone","Kursi":"Chair","Kapde":"Clothes"}
meaning = input("Enter any of the following words to know the meaning in english:- 1.) Kamra 2.) Kambal 3.) Fonn 4.) Kursi 5.) Kapde :- ")
